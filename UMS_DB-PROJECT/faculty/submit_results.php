...
<head>
    <meta charset="UTF-8">
    <title>Submit Results - Student Information Management System</title>
    ...
    <style>
        ...
        .content {
            margin-top: 250px; /* Adjust for the fixed header */
            padding: 20px;
...
<body>
    ...
    <div class="content">
        <form method="post" action="submit_results.php">
