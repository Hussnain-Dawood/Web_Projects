...
$sql="INSERT INTO `freelancer_hub`.`feedback` (`Name`, `Age`, `Gender`, `Email`, `Phone_Number`, `Information`, `Date`)
...
<head>
    ...
    <title>Welcome Suggestion Form</title>
    <link href="https://fonts.googleapis.com/css2?family=Sriracha&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="css/fdstyle.css">
   
</head>
<body>
    <img class="image" src="image/feedback2.avif">
    <div class="container">
        <h1> Suggestion Box</h1>
        <p>Enter you details and submit  to confirm your participation in the Better World </p>
      <?php
      if ($insert==true){
    ...
    <form action=" feedback.php " method="post">
        ...
        <span>
          ...
          <button class="btn">  <a href="user_page.php" style=" color:white;
    size: 24px;
    text-decoration: none;
    font-size: 20px;">Go back</a> </button>
    </span>
    </form>
    </div>
</body>
